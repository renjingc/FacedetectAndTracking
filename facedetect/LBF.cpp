...
string cascadeName = "./../xml/haarcascade_frontalface_alt.xml";
//string cascadeName = "./../xml/lbpcascade_frontalface.xml";
//string cascadeName = "./../xml/haarcascade_eye_tree_eyeglasses.xml";
